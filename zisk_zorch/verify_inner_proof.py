...
# tools/pil2-dump, plus the AIR's key artifacts — and skip loudly when the
# variable is unset. Defaults assume the fibonacci-square SpecifiedRanges
# bundle; --dump/--instance/--starkinfo override for other captures.
...
def main() -> int:
    ...
    instance = instance or _FIXTURE_INSTANCE
    starkinfo = starkinfo or dump / _FIXTURE_STARKINFO
